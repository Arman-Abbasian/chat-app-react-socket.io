...
<path fill-rule="evenodd" clip-rule="evenodd" d="M7 22.2444H17C20.65 22.2444 22.75 20.1444 22.75 16.4944V9.49438C22.75 5.84438 20.65 3.74438 17 3.74438H7C3.35 3.74438 1.25 5.84438 1.25 9.49438V16.4944C1.25 20.1444 3.35 22.2444 7 22.2444ZM2.75 9.49438C2.75 6.63438 4.14 5.24438 7 5.24438H17C19.86 5.24438 21.25 6.63438 21.25 9.49438V16.4944C21.25 19.3544 19.86 20.7444 17 20.7444H7C4.14 20.7444 2.75 19.3544 2.75 16.4944V9.49438ZM9.65978 13.0744C10.3098 13.6044 11.1598 13.8643 11.9998 13.8643C12.8398 13.8643 13.6898 13.6044 14.3298 13.0744L17.4598 10.5744C17.7898 10.3244 17.8398 9.84435 17.5798 9.52435C17.3298 9.19435 16.8498 9.14436 16.5298 9.40436L13.3998 11.9044C12.6398 12.5144 11.3498 12.5144 10.5898 11.9044L7.45978 9.40436C7.13978 9.14436 6.66978 9.20435 6.40978 9.52435C6.14978 9.84435 6.20978 10.3144 6.52978 10.5744L9.65978 13.0744Z" fill="#382F3B"/>
    ...
    <div className="Input">
          ...
          {!showPassword &&
          <span className="formSvgSpan eye" onClick={()=>setShowPassword(true)}>
            <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {showPassword &&
          <span className="formSvgSpan eye" onClick={()=>setShowPassword(false)}>
            <svg width="24" height="24" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.46992 16.2744C9.27992 16.2744 9.08992 16.2044 8.93992 16.0544C8.11992 15.2344 7.66992 14.1444 7.66992 12.9944C7.66992 10.6044 9.60992 8.66437 11.9999 8.66437C13.1499 8.66437 14.2399 9.11437 15.0599 9.93437C15.1999 10.0744 15.2799 10.2644 15.2799 10.4644C15.2799 10.6644 15.1999 10.8544 15.0599 10.9944L9.99992 16.0544C9.84992 16.2044 9.65992 16.2744 9.46992 16.2744ZM11.9999 10.1644C10.4399 10.1644 9.16992 11.4344 9.16992 12.9944C9.16992 13.4944 9.29992 13.9744 9.53992 14.3944L13.3999 10.5344C12.9799 10.2944 12.4999 10.1644 11.9999 10.1644Z" fill="#382F3B"/>
              <path d="M5.59984 19.5044C5.42984 19.5044 5.24984 19.4444 5.10984 19.3244C4.03984 18.4144 3.07984 17.2944 2.25984 15.9944C1.19984 14.3444 1.19984 11.6544 2.25984 9.99437C4.69984 6.17437 8.24984 3.97437 11.9998 3.97437C14.1998 3.97437 16.3698 4.73437 18.2698 6.16437C18.5998 6.41437 18.6698 6.88437 18.4198 7.21437C18.1698 7.54436 17.6998 7.61437 17.3698 7.36437C15.7298 6.12437 13.8698 5.47437 11.9998 5.47437C8.76984 5.47437 5.67984 7.41437 3.51984 10.8044C2.76984 11.9744 2.76984 14.0144 3.51984 15.1844C4.26984 16.3544 5.12984 17.3644 6.07984 18.1844C6.38984 18.4544 6.42984 18.9244 6.15984 19.2444C6.01984 19.4144 5.80984 19.5044 5.59984 19.5044Z" fill="#382F3B"/>
              <path d="M11.9986 22.0144C10.6686 22.0144 9.3686 21.7444 8.1186 21.2144C7.7386 21.0544 7.5586 20.6144 7.7186 20.2344C7.8786 19.8544 8.3186 19.6744 8.6986 19.8344C9.7586 20.2844 10.8686 20.5144 11.9886 20.5144C15.2186 20.5144 18.3086 18.5744 20.4686 15.1844C21.2186 14.0144 21.2186 11.9744 20.4686 10.8044C20.1586 10.3144 19.8186 9.84438 19.4586 9.40438C19.1986 9.08438 19.2486 8.61438 19.5686 8.34438C19.8886 8.08438 20.3586 8.12438 20.6286 8.45438C21.0186 8.93438 21.3986 9.45438 21.7386 9.99438C22.7986 11.6444 22.7986 14.3344 21.7386 15.9944C19.2986 19.8144 15.7486 22.0144 11.9986 22.0144Z" fill="#382F3B"/>
              <path d="M12.6896 17.2644C12.3396 17.2644 12.0196 17.0144 11.9496 16.6544C11.8696 16.2444 12.1396 15.8544 12.5496 15.7844C13.6496 15.5844 14.5696 14.6644 14.7696 13.5644C14.8496 13.1544 15.2396 12.8944 15.6496 12.9644C16.0596 13.0444 16.3296 13.4344 16.2496 13.8444C15.9296 15.5744 14.5496 16.9444 12.8296 17.2644C12.7796 17.2544 12.7396 17.2644 12.6896 17.2644Z" fill="#382F3B"/>
              <path d="M1.99945 23.7444C1.80945 23.7444 1.61945 23.6744 1.46945 23.5244C1.17945 23.2344 1.17945 22.7544 1.46945 22.4644L8.93945 14.9944C9.22945 14.7044 9.70945 14.7044 9.99945 14.9944C10.2895 15.2844 10.2895 15.7644 9.99945 16.0544L2.52945 23.5244C2.37945 23.6744 2.18945 23.7444 1.99945 23.7444Z" fill="#382F3B"/>
              <path d="M14.5287 11.2144C14.3387 11.2144 14.1488 11.1444 13.9988 10.9944C13.7088 10.7044 13.7088 10.2244 13.9988 9.93439L21.4687 2.46439C21.7587 2.17439 22.2388 2.17439 22.5288 2.46439C22.8188 2.75439 22.8188 3.23439 22.5288 3.52439L15.0588 10.9944C14.9088 11.1444 14.7187 11.2144 14.5287 11.2144Z" fill="#382F3B"/>
            </svg>
          </span>
          }
          </div>
          ...
          <span className="enter">
            حساب کاربری ندارید ? <Link className="enterLink" to="/register">ثبت نام</Link>
          </span>
        </form>
        </div>
